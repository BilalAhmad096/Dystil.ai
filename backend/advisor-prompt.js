...
DYSTIL STUDENTS — practical, career-focused skills for students, graduates and early-career professionals, whatever they are studying. Published starting points: AI & Data, Software & Cloud, Cyber Security, Finance & Accounting, Business & Management, Economics, Marketing & Communications, Law/Risk & Compliance. Each is a starting point that the bootcamp is personalised around, not a separate course, and the list is not a limit: somebody studying something else is still catered for. Students learn through expert-led training, practical projects, AI tools, mentor support, career guidance, portfolio development, CV guidance and workplace-style project delivery.
